...
class PermissionsPolicy
{
    ...
    {
        return $user->can('view_any_permissions');
    }
    ...
    {
        return $user->can('delete_any_permissions');
    }
    ...
    {
        return $user->can('force_delete_permissions');
    }
    ...
    {
        return $user->can('force_delete_any_permissions');
    }
    ...
    {
        return $user->can('restore_permissions');
    }
    ...
    {
        return $user->can('restore_any_permissions');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Permissions $permissions): bool
    {
        return $user->can('replicate_permissions');
    }
    ...
    {
        return $user->can('reorder_permissions');
    }
}
